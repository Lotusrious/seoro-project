...
const AIChat = () => {
  return (
    <div> {/* Wrapper div for this section */}
      <h2 className="text-[#121715] text-[22px] font-bold leading-tight tracking-[-0.015em] px-4 pb-3 pt-5">Talk to Seoro AI</h2>
      ...
      <div className="flex px-4 py-3 justify-center">
        <button
          className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-[#137553] text-white text-sm font-bold leading-normal tracking-[0.015em]"
        >
