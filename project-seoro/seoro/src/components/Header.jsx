...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f4f3] px-4 sm:px-10 py-0.5 relative z-50">
      <div
        className="flex items-center gap-2 sm:gap-4 text-[#121715] cursor-pointer"
      ...
      <div className="flex flex-1 justify-end items-center gap-2 sm:gap-4 md:gap-8">
        <nav className="hidden md:flex items-center gap-3 sm:gap-4 md:gap-6 lg:gap-9">
          <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 px-4 bg-white text-[#121715] text-sm font-medium leading-normal tracking-[0.015em] hover:bg-gray-200 transition-colors duration-150">
